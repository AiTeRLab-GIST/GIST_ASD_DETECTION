...
def infer(audio_file_path, model_name="audio_model", server_url="localhost:8000"):
    ...
    # flattened_audio_data = audio_data.flatten()
    ...
    try:
        ...
        if output_data is not None:
            print("Decoded output:", output_data[0].decode('utf-8'))
        else:
...
if __name__ == "__main__":
    audio_file_path = "path/to/your/audio/file.wav"  # Update this path to your audio file
